...
#define InsertCombo(x1,x2,x3) ImGui::Spacing(); ImGui::PushItemWidth(158.f); ImGui::Combo(x1, &x2, x3, IM_ARRAYSIZE(x3)); ImGui::PopItemWidth();
...
#define InsertColorPicker(x1,x2,x3) ImGui::SameLine(219.f); ImGui::ColorPicker3(x1, x2, x3);


const int windowFlags = ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoTitleBar;
